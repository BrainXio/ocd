---
name: terraform
description: Write, refactor, and audit Terraform/OpenTofu IaC with state hygiene, no hardcoded secrets, and composable modules. Use when creating, reviewing, or fixing .tf files, modules, state, or provider configs.
argument-hint: "[file path or 'audit' or 'plan']"
title: "Terraform Skill Reference"
aliases: ["terraform-skill"]
tags: ["skill", "tool", "terraform"]
created: "2026-04-24"
updated: "2026-04-24"
---
