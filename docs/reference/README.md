...
| `markdown.md`       | `**/*.md`                     | mdformat, GFM tables, frontmatter plugin, quote style, ordered list normalization |
...
| mdformat   | `.mdformat.toml` + `mdformat_frontmatter_preserve` + `mdformat-gfm` | Markdown            | `uv sync`             |
